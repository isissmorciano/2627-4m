from src.m06_progetti_sintesi_design_first.p01_rpg_expansion.modello_reference import (
    Personaggio,
    Ladro,
    Inventario,
    Oggetto,
...
from src.m06_progetti_sintesi_design_first.p01_rpg_expansion.gestore_reference import (
    salva_partita,
    carica_partita,
)
