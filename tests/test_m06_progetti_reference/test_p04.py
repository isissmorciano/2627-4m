from src.m06_progetti_sintesi_design_first.p04_gestionale_corsi_palestra.modello_reference import (
    Corso,
    Socio,
    Tessera,
)
from src.m06_progetti_sintesi_design_first.p04_gestionale_corsi_palestra.gestore_reference import (
    salva_corso,
    carica_corso,
)
