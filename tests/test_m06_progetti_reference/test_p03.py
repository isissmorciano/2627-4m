from src.m06_progetti_sintesi_design_first.p03_flotta_veicoli.modello_reference import (
    Autovettura,
    Furgone,
    Manutenzione,
)
from src.m06_progetti_sintesi_design_first.p03_flotta_veicoli.gestore_reference import (
    salva_flotta,
    carica_flotta,
)
...
def test_canone_polimorfico_furgone():
    ...
    assert furgone.calcola_canone_giornaliero() == 100.0
