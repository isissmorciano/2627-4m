from src.m06_progetti_sintesi_design_first.p02_centro_sportivo.modello_student import (
    Campo,
    Attrezzatura,
    Prenotazione,
)
from src.m06_progetti_sintesi_design_first.p02_centro_sportivo.gestore_student import (
    salva_prenotazione,
    carica_prenotazione,
)
...
def test_calcolo_costo_totale_prenotazione():
    ...
    pren.aggiungi_noleggio(racchetta, 2)  # 6.0
    pren.aggiungi_noleggio(palline, 1)   # 2.5
