...
def main() -> None:
    ...
    carta_insufficiente = CartaCredito("1234-5678", plafond_residuo=50.0)
    carta_valida = CartaCredito("1234-9999", plafond_residuo=200.0)
    bonifico = BonificoBancario("IT88X0123456789")
    ...
    print(f"Tentativo 2 (Carta con 200€ plafond) -> Esito: {es2} | Messaggio: {msg2} (Plafond rimasto: {carta_valida.plafond_residuo}€)")
