...
Apri il file `es04_student.md` e compila i **Criteri di Accettazione (Definition of Done)** dedicati alla gestione degli errori e del rifiuto, formalizzando le 4 casistiche descritte e garantendo la protezione dello stato del conto.
