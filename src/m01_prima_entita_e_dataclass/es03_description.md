...
### Parte 1 — Modellazione Statica (`es03_student.md`)
Apri `es03_student.md` e crea da zero (lo scaffolding è ridotto):
...
### Parte 2 — Implementazione in Python (`es03_student.py`)
